class Solution {
    public String addBinary(String a, String b) {
        ...
        if(carry != 0) sb.append(carry);  //if sum==2 we have a carry, else no carry 1/2 rounds down to 0 in integer arithematic
        return sb.reverse().toString();  //leftover carry, add it
    }
}
